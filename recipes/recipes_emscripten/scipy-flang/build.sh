...
cp /home/ihuicatl/Repos/Packaging/emforge-recipes-4x/llvm.tar.bz2 .
mkdir -p $LLVM_DIR
...
export CFLAGS="-I$PREFIX/include/python3.13 -I$PREFIX/include"
export CXXFLAGS="-I$PREFIX/include/python3.13 -I$PREFIX/include"
